...
class FilesSharingShareesSearchResultExact(BaseModel):
    """
    ...
    __properties = ["circles", "emails", "groups", "remote_groups", "remotes", "rooms", "users"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilesSharingShareesSearchResultExact:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilesSharingShareesSearchResultExact:
        """Create an instance of FilesSharingShareesSearchResultExact from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilesSharingShareesSearchResultExact.parse_obj(obj)

        _obj = FilesSharingShareesSearchResultExact.parse_obj({
