...
class WeatherStatusForecastDataNext1Hours(BaseModel):
    """
    WeatherStatusForecastDataNext1Hours
    """
    summary: WeatherStatusForecastDataNext12HoursSummary = Field(...)
    details: WeatherStatusForecastDataNext1HoursDetails = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WeatherStatusForecastDataNext1Hours:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WeatherStatusForecastDataNext1Hours:
        """Create an instance of WeatherStatusForecastDataNext1Hours from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WeatherStatusForecastDataNext1Hours.parse_obj(obj)

        _obj = WeatherStatusForecastDataNext1Hours.parse_obj({
            "summary": WeatherStatusForecastDataNext12HoursSummary.from_dict(obj.get("summary")) if obj.get("summary") is not None else None,
            "details": WeatherStatusForecastDataNext1HoursDetails.from_dict(obj.get("details")) if obj.get("details") is not None else None
        })
        return _obj
