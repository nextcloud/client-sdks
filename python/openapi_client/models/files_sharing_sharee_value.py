...
class FilesSharingShareeValue(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilesSharingShareeValue:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilesSharingShareeValue:
        """Create an instance of FilesSharingShareeValue from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilesSharingShareeValue.parse_obj(obj)

        _obj = FilesSharingShareeValue.parse_obj({
