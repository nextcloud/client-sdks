...
class CloudFederationApiValidationErrorAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CloudFederationApiValidationErrorAllOf:
        """Create an instance of CloudFederationApiValidationErrorAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CloudFederationApiValidationErrorAllOf:
        """Create an instance of CloudFederationApiValidationErrorAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CloudFederationApiValidationErrorAllOf.parse_obj(obj)

        _obj = CloudFederationApiValidationErrorAllOf.parse_obj({
