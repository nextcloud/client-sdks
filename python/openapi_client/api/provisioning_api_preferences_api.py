...
class ProvisioningApiPreferencesApi(object):
    ...
    @validate_arguments
    def provisioning_api_preferences_delete_multiple_preference(self, config_keys : Annotated[StrictStr, Field(..., description="Keys to delete")], app_id : Annotated[StrictStr, Field(..., description="ID of the app")], ocs_api_request : StrictStr, **kwargs) -> CoreWhatsNewDismiss200Response:  # noqa: E501
    ...
    @validate_arguments
    def provisioning_api_preferences_delete_multiple_preference_with_http_info(self, config_keys : Annotated[StrictStr, Field(..., description="Keys to delete")], app_id : Annotated[StrictStr, Field(..., description="ID of the app")], ocs_api_request : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete multiple preferences for an app  # noqa: E501
