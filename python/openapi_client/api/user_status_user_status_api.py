...
class UserStatusUserStatusApi(object):
    ...
    @validate_arguments
    def user_status_user_status_revert_status(self, message_id : Annotated[StrictStr, Field(..., description="ID of the message to delete")], ocs_api_request : StrictStr, **kwargs) -> UserStatusUserStatusGetStatus200Response:  # noqa: E501
