...
class WeatherStatusWeatherStatusApi(object):
    ...
    @validate_arguments
    def weather_status_weather_status_set_favorites(self, favorites : Annotated[StrictStr, Field(..., description="Favorite addresses")], ocs_api_request : StrictStr, **kwargs) -> CoreReferenceApiTouchProvider200Response:  # noqa: E501
    ...
    @validate_arguments
    def weather_status_weather_status_set_favorites_with_http_info(self, favorites : Annotated[StrictStr, Field(..., description="Favorite addresses")], ocs_api_request : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """Set favorites list  # noqa: E501
