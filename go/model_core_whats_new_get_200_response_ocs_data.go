...
type CoreWhatsNewGet200ResponseOcsData struct {
	...
	WhatsNew CoreWhatsNewGet200ResponseOcsDataWhatsNew `json:"whatsNew"`
}
...
// GetWhatsNew returns the WhatsNew field value
...
// GetWhatsNewOk returns a tuple with the WhatsNew field value
// and a boolean to check if the value has been set.
