...
type ApiUserStatusPredefinedStatusFindAllRequest struct {
	ctx context.Context
	ApiService *UserStatusPredefinedStatusApiService
	oCSAPIRequest *string
}

func (r ApiUserStatusPredefinedStatusFindAllRequest) OCSAPIRequest(oCSAPIRequest string) ApiUserStatusPredefinedStatusFindAllRequest {
	r.oCSAPIRequest = &oCSAPIRequest
	return r
}

func (r ApiUserStatusPredefinedStatusFindAllRequest) Execute() (*UserStatusPredefinedStatusFindAll200Response, *http.Response, error) {
...
UserStatusPredefinedStatusFindAll Get all predefined messages
 ...
 @return ApiUserStatusPredefinedStatusFindAllRequest
*/
func (a *UserStatusPredefinedStatusApiService) UserStatusPredefinedStatusFindAll(ctx context.Context) ApiUserStatusPredefinedStatusFindAllRequest {
	return ApiUserStatusPredefinedStatusFindAllRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UserStatusPredefinedStatusApiService) UserStatusPredefinedStatusFindAllExecute(r ApiUserStatusPredefinedStatusFindAllRequest) (*UserStatusPredefinedStatusFindAll200Response, *http.Response, error) {
	var (
