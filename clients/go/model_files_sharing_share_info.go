...
type FilesSharingShareInfo struct {
	...
	Size FilesSharingShareInfoSize `json:"size"`
	Type string `json:"type"`
	Etag string `json:"etag"`
	Children []map[string]map[string]interface{} `json:"children,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _FilesSharingShareInfo FilesSharingShareInfo
...
func (o *FilesSharingShareInfo) GetSize() FilesSharingShareInfoSize {
	if o == nil {
		var ret FilesSharingShareInfoSize
		return ret
	}
...
// SetChildren gets a reference to the given []map[string]map[string]interface{} and assigns it to the Children field.
...
func (o *FilesSharingShareInfo) UnmarshalJSON(bytes []byte) (err error) {
	varFilesSharingShareInfo := _FilesSharingShareInfo{}

	if err = json.Unmarshal(bytes, &varFilesSharingShareInfo); err == nil {
		*o = FilesSharingShareInfo(varFilesSharingShareInfo)
	}
