...
type _DashboardDashboardApiGetWidgets200Response DashboardDashboardApiGetWidgets200Response
...
func (o *DashboardDashboardApiGetWidgets200Response) UnmarshalJSON(bytes []byte) (err error) {
	varDashboardDashboardApiGetWidgets200Response := _DashboardDashboardApiGetWidgets200Response{}

	if err = json.Unmarshal(bytes, &varDashboardDashboardApiGetWidgets200Response); err == nil {
		*o = DashboardDashboardApiGetWidgets200Response(varDashboardDashboardApiGetWidgets200Response)
	}
