...
type _FilesSharingDeletedShare FilesSharingDeletedShare
...
func (o *FilesSharingDeletedShare) UnmarshalJSON(bytes []byte) (err error) {
	varFilesSharingDeletedShare := _FilesSharingDeletedShare{}

	if err = json.Unmarshal(bytes, &varFilesSharingDeletedShare); err == nil {
		*o = FilesSharingDeletedShare(varFilesSharingDeletedShare)
	}
