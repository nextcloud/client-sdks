...
type _FilesSharingShareesRecommendedResultExact FilesSharingShareesRecommendedResultExact
...
func (o *FilesSharingShareesRecommendedResultExact) UnmarshalJSON(bytes []byte) (err error) {
	varFilesSharingShareesRecommendedResultExact := _FilesSharingShareesRecommendedResultExact{}

	if err = json.Unmarshal(bytes, &varFilesSharingShareesRecommendedResultExact); err == nil {
		*o = FilesSharingShareesRecommendedResultExact(varFilesSharingShareesRecommendedResultExact)
	}
