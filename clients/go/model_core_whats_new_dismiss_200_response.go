...
type _CoreWhatsNewDismiss200Response CoreWhatsNewDismiss200Response
...
func (o *CoreWhatsNewDismiss200Response) UnmarshalJSON(bytes []byte) (err error) {
	varCoreWhatsNewDismiss200Response := _CoreWhatsNewDismiss200Response{}

	if err = json.Unmarshal(bytes, &varCoreWhatsNewDismiss200Response); err == nil {
		*o = CoreWhatsNewDismiss200Response(varCoreWhatsNewDismiss200Response)
	}
