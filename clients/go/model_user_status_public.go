...
type _UserStatusPublic UserStatusPublic
...
func (o *UserStatusPublic) UnmarshalJSON(bytes []byte) (err error) {
	varUserStatusPublic := _UserStatusPublic{}

	if err = json.Unmarshal(bytes, &varUserStatusPublic); err == nil {
		*o = UserStatusPublic(varUserStatusPublic)
	}
