...
type _FilesSharingShareeRemoteAllOfValue FilesSharingShareeRemoteAllOfValue
...
func (o *FilesSharingShareeRemoteAllOfValue) UnmarshalJSON(bytes []byte) (err error) {
	varFilesSharingShareeRemoteAllOfValue := _FilesSharingShareeRemoteAllOfValue{}

	if err = json.Unmarshal(bytes, &varFilesSharingShareeRemoteAllOfValue); err == nil {
		*o = FilesSharingShareeRemoteAllOfValue(varFilesSharingShareeRemoteAllOfValue)
	}
