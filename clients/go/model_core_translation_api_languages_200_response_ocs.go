...
type _CoreTranslationApiLanguages200ResponseOcs CoreTranslationApiLanguages200ResponseOcs
...
func (o *CoreTranslationApiLanguages200ResponseOcs) UnmarshalJSON(bytes []byte) (err error) {
	varCoreTranslationApiLanguages200ResponseOcs := _CoreTranslationApiLanguages200ResponseOcs{}

	if err = json.Unmarshal(bytes, &varCoreTranslationApiLanguages200ResponseOcs); err == nil {
		*o = CoreTranslationApiLanguages200ResponseOcs(varCoreTranslationApiLanguages200ResponseOcs)
	}
