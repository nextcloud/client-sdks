...
type _CoreLoginFlowV2Credentials CoreLoginFlowV2Credentials
...
func (o *CoreLoginFlowV2Credentials) UnmarshalJSON(bytes []byte) (err error) {
	varCoreLoginFlowV2Credentials := _CoreLoginFlowV2Credentials{}

	if err = json.Unmarshal(bytes, &varCoreLoginFlowV2Credentials); err == nil {
		*o = CoreLoginFlowV2Credentials(varCoreLoginFlowV2Credentials)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "loginName")
