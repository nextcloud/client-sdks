...
type _CoreAutocompleteResult CoreAutocompleteResult
...
func (o *CoreAutocompleteResult) UnmarshalJSON(bytes []byte) (err error) {
	varCoreAutocompleteResult := _CoreAutocompleteResult{}

	if err = json.Unmarshal(bytes, &varCoreAutocompleteResult); err == nil {
		*o = CoreAutocompleteResult(varCoreAutocompleteResult)
	}
