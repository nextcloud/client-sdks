...
func (o *CoreStatus) UnmarshalJSON(bytes []byte) (err error) {
	varCoreStatus := _CoreStatus{}

	if err = json.Unmarshal(bytes, &varCoreStatus); err == nil {
		*o = CoreStatus(varCoreStatus)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "needsDbUpgrade")
