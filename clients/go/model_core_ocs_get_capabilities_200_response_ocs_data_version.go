...
type _CoreOcsGetCapabilities200ResponseOcsDataVersion CoreOcsGetCapabilities200ResponseOcsDataVersion
...
func (o *CoreOcsGetCapabilities200ResponseOcsDataVersion) UnmarshalJSON(bytes []byte) (err error) {
	varCoreOcsGetCapabilities200ResponseOcsDataVersion := _CoreOcsGetCapabilities200ResponseOcsDataVersion{}

	if err = json.Unmarshal(bytes, &varCoreOcsGetCapabilities200ResponseOcsDataVersion); err == nil {
		*o = CoreOcsGetCapabilities200ResponseOcsDataVersion(varCoreOcsGetCapabilities200ResponseOcsDataVersion)
	}
