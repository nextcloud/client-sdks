...
type _UserStatusPredefined UserStatusPredefined
...
func (o *UserStatusPredefined) UnmarshalJSON(bytes []byte) (err error) {
	varUserStatusPredefined := _UserStatusPredefined{}

	if err = json.Unmarshal(bytes, &varUserStatusPredefined); err == nil {
		*o = UserStatusPredefined(varUserStatusPredefined)
	}
