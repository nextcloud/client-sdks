...
type _FilesSharingShareeUser FilesSharingShareeUser
...
func (o *FilesSharingShareeUser) UnmarshalJSON(bytes []byte) (err error) {
	varFilesSharingShareeUser := _FilesSharingShareeUser{}

	if err = json.Unmarshal(bytes, &varFilesSharingShareeUser); err == nil {
		*o = FilesSharingShareeUser(varFilesSharingShareeUser)
	}
