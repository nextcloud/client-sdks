...
type _CoreWipeCheckWipe200Response CoreWipeCheckWipe200Response
...
func (o *CoreWipeCheckWipe200Response) UnmarshalJSON(bytes []byte) (err error) {
	varCoreWipeCheckWipe200Response := _CoreWipeCheckWipe200Response{}

	if err = json.Unmarshal(bytes, &varCoreWipeCheckWipe200Response); err == nil {
		*o = CoreWipeCheckWipe200Response(varCoreWipeCheckWipe200Response)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "wipe")
