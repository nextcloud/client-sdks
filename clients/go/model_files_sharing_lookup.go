...
type _FilesSharingLookup FilesSharingLookup
...
func (o *FilesSharingLookup) UnmarshalJSON(bytes []byte) (err error) {
	varFilesSharingLookup := _FilesSharingLookup{}

	if err = json.Unmarshal(bytes, &varFilesSharingLookup); err == nil {
		*o = FilesSharingLookup(varFilesSharingLookup)
	}
