...
type FilesSharingCapabilities struct {
	FilesSharing FilesSharingCapabilitiesFilesSharing `json:"files_sharing"`
	AdditionalProperties map[string]interface{}
}

type _FilesSharingCapabilities FilesSharingCapabilities
...
func (o *FilesSharingCapabilities) GetFilesSharing() FilesSharingCapabilitiesFilesSharing {
	if o == nil {
		var ret FilesSharingCapabilitiesFilesSharing
		return ret
	}
...
func (o *FilesSharingCapabilities) UnmarshalJSON(bytes []byte) (err error) {
	varFilesSharingCapabilities := _FilesSharingCapabilities{}

	if err = json.Unmarshal(bytes, &varFilesSharingCapabilities); err == nil {
		*o = FilesSharingCapabilities(varFilesSharingCapabilities)
	}
