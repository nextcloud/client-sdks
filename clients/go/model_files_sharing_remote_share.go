...
type _FilesSharingRemoteShare FilesSharingRemoteShare
...
func (o *FilesSharingRemoteShare) UnmarshalJSON(bytes []byte) (err error) {
	varFilesSharingRemoteShare := _FilesSharingRemoteShare{}

	if err = json.Unmarshal(bytes, &varFilesSharingRemoteShare); err == nil {
		*o = FilesSharingRemoteShare(varFilesSharingRemoteShare)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "share_token")
