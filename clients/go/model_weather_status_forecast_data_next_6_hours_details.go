...
type _WeatherStatusForecastDataNext6HoursDetails WeatherStatusForecastDataNext6HoursDetails
...
func (o *WeatherStatusForecastDataNext6HoursDetails) UnmarshalJSON(bytes []byte) (err error) {
	varWeatherStatusForecastDataNext6HoursDetails := _WeatherStatusForecastDataNext6HoursDetails{}

	if err = json.Unmarshal(bytes, &varWeatherStatusForecastDataNext6HoursDetails); err == nil {
		*o = WeatherStatusForecastDataNext6HoursDetails(varWeatherStatusForecastDataNext6HoursDetails)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "air_temperature_max")
		delete(additionalProperties, "air_temperature_min")
