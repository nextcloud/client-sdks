...
type _FilesSharingShareeRemoteGroup FilesSharingShareeRemoteGroup
...
func (o *FilesSharingShareeRemoteGroup) UnmarshalJSON(bytes []byte) (err error) {
	varFilesSharingShareeRemoteGroup := _FilesSharingShareeRemoteGroup{}

	if err = json.Unmarshal(bytes, &varFilesSharingShareeRemoteGroup); err == nil {
		*o = FilesSharingShareeRemoteGroup(varFilesSharingShareeRemoteGroup)
	}
