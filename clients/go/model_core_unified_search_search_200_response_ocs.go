...
type _CoreUnifiedSearchSearch200ResponseOcs CoreUnifiedSearchSearch200ResponseOcs
...
func (o *CoreUnifiedSearchSearch200ResponseOcs) UnmarshalJSON(bytes []byte) (err error) {
	varCoreUnifiedSearchSearch200ResponseOcs := _CoreUnifiedSearchSearch200ResponseOcs{}

	if err = json.Unmarshal(bytes, &varCoreUnifiedSearchSearch200ResponseOcs); err == nil {
		*o = CoreUnifiedSearchSearch200ResponseOcs(varCoreUnifiedSearchSearch200ResponseOcs)
	}
