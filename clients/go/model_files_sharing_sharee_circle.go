...
type _FilesSharingShareeCircle FilesSharingShareeCircle
...
func (o *FilesSharingShareeCircle) UnmarshalJSON(bytes []byte) (err error) {
	varFilesSharingShareeCircle := _FilesSharingShareeCircle{}

	if err = json.Unmarshal(bytes, &varFilesSharingShareeCircle); err == nil {
		*o = FilesSharingShareeCircle(varFilesSharingShareeCircle)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "shareWithDescription")
