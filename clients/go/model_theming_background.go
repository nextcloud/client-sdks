...
type _ThemingBackground ThemingBackground
...
func (o *ThemingBackground) UnmarshalJSON(bytes []byte) (err error) {
	varThemingBackground := _ThemingBackground{}

	if err = json.Unmarshal(bytes, &varThemingBackground); err == nil {
		*o = ThemingBackground(varThemingBackground)
	}
