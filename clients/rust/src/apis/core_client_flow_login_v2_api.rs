...
pub async fn core_client_flow_login_v2_init(configuration: &configuration::Configuration, ) -> Result<crate::models::CoreLoginFlowV2, Error<CoreClientFlowLoginV2InitError>> {
...
pub async fn core_client_flow_login_v2_poll(configuration: &configuration::Configuration, token: &str) -> Result<crate::models::CoreLoginFlowV2Credentials, Error<CoreClientFlowLoginV2PollError>> {
    let local_var_configuration = configuration;
