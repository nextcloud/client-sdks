...
pub async fn files_sharing_share_info_info(configuration: &configuration::Configuration, t: &str, password: Option<&str>, dir: Option<&str>, depth: Option<i64>) -> Result<crate::models::FilesSharingShareInfo, Error<FilesSharingShareInfoInfoError>> {
