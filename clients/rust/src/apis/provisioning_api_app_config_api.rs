...
pub async fn provisioning_api_app_config_delete_key(configuration: &configuration::Configuration, app: &str, key: &str, ocs_api_request: &str) -> Result<crate::models::CoreWhatsNewDismiss200Response, Error<ProvisioningApiAppConfigDeleteKeyError>> {
...
/// This endpoint requires admin access
pub async fn provisioning_api_app_config_get_apps(configuration: &configuration::Configuration, ocs_api_request: &str) -> Result<crate::models::ProvisioningApiAppConfigGetApps200Response, Error<ProvisioningApiAppConfigGetAppsError>> {
    let local_var_configuration = configuration;
...
/// This endpoint requires admin access
pub async fn provisioning_api_app_config_get_keys(configuration: &configuration::Configuration, app: &str, ocs_api_request: &str) -> Result<crate::models::ProvisioningApiAppConfigGetApps200Response, Error<ProvisioningApiAppConfigGetKeysError>> {
    let local_var_configuration = configuration;
...
/// This endpoint requires admin access
pub async fn provisioning_api_app_config_get_value(configuration: &configuration::Configuration, app: &str, key: &str, ocs_api_request: &str, default_value: Option<&str>) -> Result<crate::models::ProvisioningApiAppConfigGetValue200Response, Error<ProvisioningApiAppConfigGetValueError>> {
    let local_var_configuration = configuration;
...
pub async fn provisioning_api_app_config_set_value(configuration: &configuration::Configuration, value: &str, app: &str, key: &str, ocs_api_request: &str) -> Result<crate::models::CoreWhatsNewDismiss200Response, Error<ProvisioningApiAppConfigSetValueError>> {
    let local_var_configuration = configuration;
