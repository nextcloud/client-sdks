...
pub async fn files_sharing_remote_accept_share(configuration: &configuration::Configuration, id: i64, ocs_api_request: &str) -> Result<crate::models::CoreWhatsNewDismiss200Response, Error<FilesSharingRemoteAcceptShareError>> {
...
pub async fn files_sharing_remote_decline_share(configuration: &configuration::Configuration, id: i64, ocs_api_request: &str) -> Result<crate::models::CoreWhatsNewDismiss200Response, Error<FilesSharingRemoteDeclineShareError>> {
    let local_var_configuration = configuration;
...
pub async fn files_sharing_remote_get_open_shares(configuration: &configuration::Configuration, ocs_api_request: &str) -> Result<crate::models::FilesSharingRemoteGetShares200Response, Error<FilesSharingRemoteGetOpenSharesError>> {
    let local_var_configuration = configuration;
...
pub async fn files_sharing_remote_get_share(configuration: &configuration::Configuration, id: i64, ocs_api_request: &str) -> Result<crate::models::FilesSharingRemoteGetShare200Response, Error<FilesSharingRemoteGetShareError>> {
    let local_var_configuration = configuration;
...
pub async fn files_sharing_remote_get_shares(configuration: &configuration::Configuration, ocs_api_request: &str) -> Result<crate::models::FilesSharingRemoteGetShares200Response, Error<FilesSharingRemoteGetSharesError>> {
    let local_var_configuration = configuration;
...
pub async fn files_sharing_remote_unshare(configuration: &configuration::Configuration, id: i64, ocs_api_request: &str) -> Result<crate::models::CoreWhatsNewDismiss200Response, Error<FilesSharingRemoteUnshareError>> {
    let local_var_configuration = configuration;
