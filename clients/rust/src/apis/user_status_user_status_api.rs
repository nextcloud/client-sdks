...
pub async fn user_status_user_status_clear_message(configuration: &configuration::Configuration, ocs_api_request: &str) -> Result<crate::models::CoreWhatsNewDismiss200Response, Error<UserStatusUserStatusClearMessageError>> {
...
pub async fn user_status_user_status_get_status(configuration: &configuration::Configuration, ocs_api_request: &str) -> Result<crate::models::UserStatusUserStatusGetStatus200Response, Error<UserStatusUserStatusGetStatusError>> {
    let local_var_configuration = configuration;
...
pub async fn user_status_user_status_revert_status(configuration: &configuration::Configuration, message_id: &str, ocs_api_request: &str) -> Result<crate::models::UserStatusUserStatusRevertStatus200Response, Error<UserStatusUserStatusRevertStatusError>> {
    let local_var_configuration = configuration;
...
pub async fn user_status_user_status_set_custom_message(configuration: &configuration::Configuration, ocs_api_request: &str, status_icon: Option<&str>, message: Option<&str>, clear_at: Option<i64>) -> Result<crate::models::UserStatusUserStatusGetStatus200Response, Error<UserStatusUserStatusSetCustomMessageError>> {
    let local_var_configuration = configuration;
...
pub async fn user_status_user_status_set_predefined_message(configuration: &configuration::Configuration, message_id: &str, ocs_api_request: &str, clear_at: Option<i64>) -> Result<crate::models::UserStatusUserStatusGetStatus200Response, Error<UserStatusUserStatusSetPredefinedMessageError>> {
    let local_var_configuration = configuration;
...
pub async fn user_status_user_status_set_status(configuration: &configuration::Configuration, status_type: &str, ocs_api_request: &str) -> Result<crate::models::UserStatusUserStatusGetStatus200Response, Error<UserStatusUserStatusSetStatusError>> {
    let local_var_configuration = configuration;
