...
pub async fn dav_direct_get_url(configuration: &configuration::Configuration, file_id: i64, ocs_api_request: &str, expiration_time: Option<i64>) -> Result<crate::models::DavDirectGetUrl200Response, Error<DavDirectGetUrlError>> {
