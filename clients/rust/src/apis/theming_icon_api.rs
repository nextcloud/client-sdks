...
pub async fn theming_icon_get_favicon(configuration: &configuration::Configuration, app: &str) -> Result<std::path::PathBuf, Error<ThemingIconGetFaviconError>> {
...
pub async fn theming_icon_get_themed_icon(configuration: &configuration::Configuration, app: &str, image: &str) -> Result<std::path::PathBuf, Error<ThemingIconGetThemedIconError>> {
    let local_var_configuration = configuration;
...
pub async fn theming_icon_get_touch_icon(configuration: &configuration::Configuration, app: &str) -> Result<std::path::PathBuf, Error<ThemingIconGetTouchIconError>> {
    let local_var_configuration = configuration;
