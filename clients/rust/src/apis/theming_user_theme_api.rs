...
pub async fn theming_user_theme_delete_background(configuration: &configuration::Configuration, ocs_api_request: &str) -> Result<crate::models::ThemingBackground, Error<ThemingUserThemeDeleteBackgroundError>> {
...
pub async fn theming_user_theme_disable_theme(configuration: &configuration::Configuration, theme_id: &str, ocs_api_request: &str) -> Result<crate::models::CoreWhatsNewDismiss200Response, Error<ThemingUserThemeDisableThemeError>> {
    let local_var_configuration = configuration;
...
pub async fn theming_user_theme_enable_theme(configuration: &configuration::Configuration, theme_id: &str, ocs_api_request: &str) -> Result<crate::models::CoreWhatsNewDismiss200Response, Error<ThemingUserThemeEnableThemeError>> {
    let local_var_configuration = configuration;
...
pub async fn theming_user_theme_get_background(configuration: &configuration::Configuration, ocs_api_request: &str) -> Result<std::path::PathBuf, Error<ThemingUserThemeGetBackgroundError>> {
    let local_var_configuration = configuration;
...
pub async fn theming_user_theme_set_background(configuration: &configuration::Configuration, r#type: &str, ocs_api_request: &str, value: Option<&str>, color: Option<&str>) -> Result<crate::models::ThemingBackground, Error<ThemingUserThemeSetBackgroundError>> {
    let local_var_configuration = configuration;
