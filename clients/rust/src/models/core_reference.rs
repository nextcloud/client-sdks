...
impl CoreReference {
    pub fn new(rich_object_type: String, rich_object: ::std::collections::HashMap<String, serde_json::Value>, open_graph_object: crate::models::CoreOpenGraphObject, accessible: bool) -> CoreReference {
        CoreReference {
            rich_object_type,
            rich_object,
