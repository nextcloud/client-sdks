...
class FilesTemplateCreate200ResponseOcs(BaseModel):
    """
    FilesTemplateCreate200ResponseOcs
    """
    meta: OCSMeta = Field(...)
    data: FilesTemplateFile = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilesTemplateCreate200ResponseOcs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilesTemplateCreate200ResponseOcs:
        """Create an instance of FilesTemplateCreate200ResponseOcs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilesTemplateCreate200ResponseOcs.parse_obj(obj)

        _obj = FilesTemplateCreate200ResponseOcs.parse_obj({
            "meta": OCSMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": FilesTemplateFile.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
