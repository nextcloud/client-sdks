...
class WeatherStatusForecastDataNext12Hours(BaseModel):
    """
    WeatherStatusForecastDataNext12Hours
    """
    summary: WeatherStatusForecastDataNext12HoursSummary = Field(...)
    details: WeatherStatusForecastDataNext12HoursDetails = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WeatherStatusForecastDataNext12Hours:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WeatherStatusForecastDataNext12Hours:
        """Create an instance of WeatherStatusForecastDataNext12Hours from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WeatherStatusForecastDataNext12Hours.parse_obj(obj)

        _obj = WeatherStatusForecastDataNext12Hours.parse_obj({
            "summary": WeatherStatusForecastDataNext12HoursSummary.from_dict(obj.get("summary")) if obj.get("summary") is not None else None,
            "details": WeatherStatusForecastDataNext12HoursDetails.from_dict(obj.get("details")) if obj.get("details") is not None else None
        })
