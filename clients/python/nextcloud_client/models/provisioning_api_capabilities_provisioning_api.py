...
class ProvisioningApiCapabilitiesProvisioningApi(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProvisioningApiCapabilitiesProvisioningApi:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProvisioningApiCapabilitiesProvisioningApi:
        """Create an instance of ProvisioningApiCapabilitiesProvisioningApi from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProvisioningApiCapabilitiesProvisioningApi.parse_obj(obj)

        _obj = ProvisioningApiCapabilitiesProvisioningApi.parse_obj({
