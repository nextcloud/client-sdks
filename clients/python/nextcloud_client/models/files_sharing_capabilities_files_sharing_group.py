...
class FilesSharingCapabilitiesFilesSharingGroup(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilesSharingCapabilitiesFilesSharingGroup:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilesSharingCapabilitiesFilesSharingGroup:
        """Create an instance of FilesSharingCapabilitiesFilesSharingGroup from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilesSharingCapabilitiesFilesSharingGroup.parse_obj(obj)

        _obj = FilesSharingCapabilitiesFilesSharingGroup.parse_obj({
