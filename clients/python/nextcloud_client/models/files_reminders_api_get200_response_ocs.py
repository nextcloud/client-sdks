...
class FilesRemindersApiGet200ResponseOcs(BaseModel):
    """
    FilesRemindersApiGet200ResponseOcs
    """
    meta: OCSMeta = Field(...)
    data: FilesRemindersApiGet200ResponseOcsData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilesRemindersApiGet200ResponseOcs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilesRemindersApiGet200ResponseOcs:
        """Create an instance of FilesRemindersApiGet200ResponseOcs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilesRemindersApiGet200ResponseOcs.parse_obj(obj)

        _obj = FilesRemindersApiGet200ResponseOcs.parse_obj({
            "meta": OCSMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": FilesRemindersApiGet200ResponseOcsData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
