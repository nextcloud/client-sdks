...
class FilesDirectEditingInfo200ResponseOcs(BaseModel):
    """
    FilesDirectEditingInfo200ResponseOcs
    """
    meta: OCSMeta = Field(...)
    data: FilesDirectEditingInfo200ResponseOcsData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilesDirectEditingInfo200ResponseOcs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilesDirectEditingInfo200ResponseOcs:
        """Create an instance of FilesDirectEditingInfo200ResponseOcs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilesDirectEditingInfo200ResponseOcs.parse_obj(obj)

        _obj = FilesDirectEditingInfo200ResponseOcs.parse_obj({
            "meta": OCSMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": FilesDirectEditingInfo200ResponseOcsData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
