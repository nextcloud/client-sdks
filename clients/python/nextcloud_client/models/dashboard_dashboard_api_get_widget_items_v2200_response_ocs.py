...
class DashboardDashboardApiGetWidgetItemsV2200ResponseOcs(BaseModel):
    """
    DashboardDashboardApiGetWidgetItemsV2200ResponseOcs
    """
    meta: OCSMeta = Field(...)
    data: Dict[str, DashboardWidgetItems] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DashboardDashboardApiGetWidgetItemsV2200ResponseOcs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DashboardDashboardApiGetWidgetItemsV2200ResponseOcs:
        """Create an instance of DashboardDashboardApiGetWidgetItemsV2200ResponseOcs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DashboardDashboardApiGetWidgetItemsV2200ResponseOcs.parse_obj(obj)

        _obj = DashboardDashboardApiGetWidgetItemsV2200ResponseOcs.parse_obj({
            "meta": OCSMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, DashboardWidgetItems.from_dict(_v))
