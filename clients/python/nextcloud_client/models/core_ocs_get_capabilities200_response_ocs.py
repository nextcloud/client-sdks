...
class CoreOcsGetCapabilities200ResponseOcs(BaseModel):
    """
    CoreOcsGetCapabilities200ResponseOcs
    """
    meta: OCSMeta = Field(...)
    data: CoreOcsGetCapabilities200ResponseOcsData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CoreOcsGetCapabilities200ResponseOcs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CoreOcsGetCapabilities200ResponseOcs:
        """Create an instance of CoreOcsGetCapabilities200ResponseOcs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CoreOcsGetCapabilities200ResponseOcs.parse_obj(obj)

        _obj = CoreOcsGetCapabilities200ResponseOcs.parse_obj({
            "meta": OCSMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": CoreOcsGetCapabilities200ResponseOcsData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
