...
class FilesSharingShareesRecommendedResultExact(BaseModel):
    """
    ...
    __properties = ["emails", "groups", "remote_groups", "remotes", "users"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilesSharingShareesRecommendedResultExact:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilesSharingShareesRecommendedResultExact:
        """Create an instance of FilesSharingShareesRecommendedResultExact from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilesSharingShareesRecommendedResultExact.parse_obj(obj)

        _obj = FilesSharingShareesRecommendedResultExact.parse_obj({
