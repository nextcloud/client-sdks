...
class ProvisioningApiUsersAddUser200ResponseOcs(BaseModel):
    """
    ProvisioningApiUsersAddUser200ResponseOcs
    """
    meta: OCSMeta = Field(...)
    data: ProvisioningApiGroupsGetGroupUsersDetails200ResponseOcsDataUsersValueOneOf = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProvisioningApiUsersAddUser200ResponseOcs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProvisioningApiUsersAddUser200ResponseOcs:
        """Create an instance of ProvisioningApiUsersAddUser200ResponseOcs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProvisioningApiUsersAddUser200ResponseOcs.parse_obj(obj)

        _obj = ProvisioningApiUsersAddUser200ResponseOcs.parse_obj({
            "meta": OCSMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": ProvisioningApiGroupsGetGroupUsersDetails200ResponseOcsDataUsersValueOneOf.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
