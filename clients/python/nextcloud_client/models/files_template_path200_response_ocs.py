...
class FilesTemplatePath200ResponseOcs(BaseModel):
    """
    FilesTemplatePath200ResponseOcs
    """
    meta: OCSMeta = Field(...)
    data: FilesTemplatePath200ResponseOcsData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilesTemplatePath200ResponseOcs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilesTemplatePath200ResponseOcs:
        """Create an instance of FilesTemplatePath200ResponseOcs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilesTemplatePath200ResponseOcs.parse_obj(obj)

        _obj = FilesTemplatePath200ResponseOcs.parse_obj({
            "meta": OCSMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": FilesTemplatePath200ResponseOcsData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
