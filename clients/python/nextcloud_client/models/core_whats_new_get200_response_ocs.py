...
class CoreWhatsNewGet200ResponseOcs(BaseModel):
    """
    CoreWhatsNewGet200ResponseOcs
    """
    meta: OCSMeta = Field(...)
    data: CoreWhatsNewGet200ResponseOcsData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CoreWhatsNewGet200ResponseOcs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CoreWhatsNewGet200ResponseOcs:
        """Create an instance of CoreWhatsNewGet200ResponseOcs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CoreWhatsNewGet200ResponseOcs.parse_obj(obj)

        _obj = CoreWhatsNewGet200ResponseOcs.parse_obj({
            "meta": OCSMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": CoreWhatsNewGet200ResponseOcsData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
