...
use nextcloud_client_sdk::apis::configuration::{Configuration};
use nextcloud_client_sdk::apis::provisioning_api_users_api::{provisioning_api_users_get_current_user};
...
async fn main() {
    ...
    println!("{}", response.unwrap().ocs.data.displayname);
}
